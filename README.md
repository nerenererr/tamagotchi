...
Open the Tamagotchi.java file

2. Place Breakpoints

Click on the left margin (next to the line numbers) at the indicated locations
A red circle 🔴 will appear indicating the active breakpoint
Breakpoints can be activated/deactivated by clicking on them

3. Run in Debug Mode

Go to the Main.java class (or your test class)
Right-click on the file
Select "Debug 'Main'" (has a bug icon 🐛)
Or use the keyboard shortcut: Shift + F9
...
Screenshots
1. Complete Code
<img width="1263" height="928" alt="Captura de pantalla 2026-01-23 090049" src="https://github.com/user-attachments/assets/b4b85a60-3658-4cd5-89fd-3f9323bf6279" />

Shows the complete implementation of the Tamagotchi class with all its methods.

2. Breakpoint 1 - play() Method
<img width="1908" height="1012" alt="Captura de pantalla 2026-01-23 085104" src="https://github.com/user-attachments/assets/477cf6b8-1877-433b-aea5-43d34e404289" />
...
<img width="1903" height="1016" alt="Captura de pantalla 2026-01-23 085130" src="https://github.com/user-attachments/assets/b9e0ebb3-5dcf-4d74-a1ac-374f18ff9b9e" />
